    ...
    if st.form_submit_button('Get my books'):
        ...
        if prediction.get("book_list"):
            ...
            with st.spinner("**:red[Chat GPT]** is generating an explanation..."):
                ...
                ### Chat GPT comment
                chat_input = f"""Someone enjoyed watching the movies {movie_titles}, write a 3-sentence
                paragraph explaining why this person might enjoy reading {prediction["book_list"]}"""
